...
from lib.models.vit.utils.layers import TransformerEncoder
...
class ViT(nn.Module):
    def __init__(self,
        ...
        num_tokens = (self.patch**2) + 1 if self.is_cls_token else (self.patch
                                                                    **2)
    ...
    def forward(self, x):
        ...
        if self.is_cls_token:
            out = torch.cat([self.cls_token.repeat(out.size(0), 1, 1), out],
                            dim=1)
