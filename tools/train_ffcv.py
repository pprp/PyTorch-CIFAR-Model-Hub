...
from lib.dataset.ffcv.make_dataloader import make_dataloaders
...
def main():
    ...
    loaders, start_time = make_dataloaders(train_dataset="/home/pdluser/data/cifar10/train_ds.beton", val_dataset="/home/pdluser/data/cifar10/test_ds.beton", batch_size=args.bs, num_workers=args.nw)
